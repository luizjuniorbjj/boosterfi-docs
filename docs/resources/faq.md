...
??? question "How is BoosterFi different from other DeFi protocols?"
...
??? question "What are the lock periods?"
    | Period | Duration |
    |--------|----------|
    | Short | 1 day |
    | Medium-Short | 5 days |
...
??? question "What network does BoosterFi use?"
...
??? question "When can I claim my yields?"
...
??? question "Why USDC instead of a native token?"
    | USDC | Native Tokens |
    |------|---------------|
...
??? question "Are the smart contracts audited?"
    ...
    - :material-check: Verified on Arbiscan
    - :material-check: Open-source
    - :material-check: Admin keys renounced

??? question "What does 'admin keys renounced' mean?"
...
??? question "How do I add Arbitrum to my wallet?"
...
??? question "How do I get USDC on Arbitrum?"
...
??? question "How do I get help?"
    - :material-telegram: **Telegram:** [t.me/boosterfi](https://t.me/boosterfi) — Fastest response
    - :material-email: **Email:** contact@boosterfi.app — 24-48 hour response
    - :material-twitter: **Twitter:** [@boosterfi](https://twitter.com/boosterfi) — DM us
...
??? question "Will BoosterFi have a token?"
...
[Join Telegram :material-telegram:](https://t.me/boosterfi){ .md-button .md-button--primary }

---

!!! danger "Security Reminder"
    **Never share your private keys or seed phrase with anyone. BoosterFi team will NEVER ask for them.**
